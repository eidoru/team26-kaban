...
function LandingSectionHeader({
  ...
  return (
    <div className={`mx-auto max-w-2xl text-center ${className}`}>
      <h2 className="font-heading text-3xl font-medium tracking-tight text-ink-900">{title}</h2>
...
function LandingFeatureCard({ title, description }: { title: string; description: string }) {
  return (
    <article className={ui.cardCompact}>
      <h3 className="font-heading text-base font-medium text-ink-900">{title}</h3>
  ...
  return (
    <li className="relative flex gap-6 pb-10 last:pb-0">
      {!isLast && (
        <span
          aria-hidden
          className="absolute left-[17px] top-9 h-[calc(100%-12px)] w-px bg-brand-200"
        />
      )}
      <span className="relative z-10 flex h-9 w-9 shrink-0 items-center justify-center rounded-full border-2 border-brand-900 bg-white font-heading text-sm font-medium text-brand-900">
        {step}
      </span>
...
export function LandingPage() {
  return (
    <div className="min-h-screen bg-gradient-to-b from-brand-50 to-ink-50 font-body">
      <header className={`mx-auto flex ${ui.page} items-center justify-between px-6 py-6`}>
        <span className="font-heading text-xl font-bold tracking-tight text-brand-900">Kaban</span>
        <div className="flex items-center gap-3">
          <Link
            to="/login"
            className={`inline-flex h-10 items-center justify-center ${ui.btnSecondary} px-6 text-brand-900`}
          >
            Log in
          </Link>
          <Link
      ...
      <main>
        <section className="mx-auto max-w-3xl px-6 pb-16 pt-10 text-center sm:pt-16">
          <h1 className="font-heading text-4xl font-medium tracking-tight text-ink-900 sm:text-5xl">
        ...
        <section className="border-y border-brand-100/80 bg-white/60 px-6 py-20">
        ...
        <section className="mx-auto max-w-5xl px-6 py-20">
          ...
          <div className="grid gap-6 lg:grid-cols-2">
            <div className={ui.callout}>
              <h3 className="font-heading text-lg font-medium text-brand-900">Not a payment app</h3>
            ...
            <div className={ui.cardCompact}>
              <h3 className="font-heading text-lg font-medium text-ink-900">
              ...
              <ul className="mt-4 space-y-3 text-sm text-ink-600">
                <li className="flex gap-2">
                  ...
                  <span>
                    <strong className="font-medium text-ink-900">Managers</strong> create groups,
                ...
                <li className="flex gap-2">
                  ...
                  <span>
                    <strong className="font-medium text-ink-900">Members</strong> see their turn,
                ...
                <li className="flex gap-2">
                  ...
                  <span>
                    <strong className="font-medium text-ink-900">Everyone</strong> gets
        ...
        <section className="mx-auto max-w-3xl px-6 pb-24 text-center">
          <div className={ui.card}>
            <h2 className="font-heading text-2xl font-medium tracking-tight text-ink-900">
